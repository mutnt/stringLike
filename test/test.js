...
describe('StringLike', function() {
  ...
  describe('- linebreaksToHTML()',function(){
    it('should return single line breaks converted to <BR> and two linebreaks wrapped in <p>',function(){
      ...
      T(S(text).linebreaksToHTML().s === converted_text);
    })
  })
